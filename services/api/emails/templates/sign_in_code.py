...
def sign_in_code_email(code: str) -> str:
    ...
    body = f"""
      <h1 style="{s['h1']}">Your Bilkeys verification code</h1>
      ...
      <p style="{s['muted']}"><strong>Never share this code.</strong> Bilkeys will never ask you for it. If you did not request this code, you can safely ignore this email.</p>
    """
