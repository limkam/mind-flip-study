...
function KineticMarquee() {
  return (
    <section className="overflow-hidden border-y border-gray-200 bg-[#11142c] py-5 text-white" aria-label="Bilkeys capabilities">
