/** Build a human-readable summary scope label from selected chapters. */
export function formatSummaryScope(selectedChapters = [], bookTitle = "") {
...
const ENHANCED_SUMMARY_SPECS = {
  ...
  standard: {
    overview: "A clear 3–5 sentence overview explaining what the chapter covers, why it matters, and how concepts connect",
  ...
  in_depth: {
    overview: "A detailed 5–8 sentence overview with concrete examples, connections between ideas, and exam-relevant framing",
...
/** Prompt body for AI enhanced chapter summaries (matches backend detail levels). */
export function buildEnhancedSummaryPrompt({ bookTitle, chapterList, detailLevel = "standard" }) {
