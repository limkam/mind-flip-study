...
| Android Expo export | `cd mobile && npx expo export --platform android --output-dir /tmp/bilkeys-par-058-clean-export` | Isolated committed HEAD `917c723` passes with the known Sentry warning. |
