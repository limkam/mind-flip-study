...
test("corrupt storage recovers", () => { const storage = memory(); storage.setItem("mindflip:celebrations:v1:user:1", "{"); assert.deepEqual(createSeenState({ storage, namespace: "user:1" }).entries(), []); });
