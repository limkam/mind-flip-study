...
test("all production assets are safely disabled and absent", () => { for (const item of audioAssetManifest) { assert.equal(item.enabled, false); assert.equal(item.src, undefined); } });
